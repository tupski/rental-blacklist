...
@section('title', 'Edit Footer Widget')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('admin.footer-widgets.show', $footerWidget) }}" class="btn btn-info btn-sm me-2">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">
                        <i class="fas fa-edit me-2"></i>
                        Form Edit Widget: {{ $footerWidget->title }}
                    </h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.footer-widgets.update', $footerWidget) }}" method="POST" id="widgetForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title" name="title" value="{{ old('title', $footerWidget->title) }}" required>
                                    @error('title')
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('order') is-invalid @enderror"
                                           id="order" name="order" value="{{ old('order', $footerWidget->order) }}" min="0" required>
                                    @error('order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror"
                                        ...
                                        @foreach($types as $key => $label)
                                            <option value="{{ $key }}" {{ old('type', $footerWidget->type) == $key ? 'selected' : '' }}>
                                                {{ $label }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('css_class') is-invalid @enderror"
                                           id="css_class" name="css_class" value="{{ old('css_class', $footerWidget->css_class) }}"
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                       value="1" {{ old('is_active', $footerWidget->is_active) ? 'checked' : '' }}>
                        ...
                        <div id="content-sections">
                            ...
                            <div id="text-content" class="content-section" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror"
                                              id="content" name="content" rows="5">{{ old('content', $footerWidget->content) }}</textarea>
                                    @error('content')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div id="links-content" class="content-section" style="display: none;">
                                ...
                                <div id="links-container">
                                    @php
                                        $links = old('links', $footerWidget->data['links'] ?? []);
                                    @endphp
                                    @if($links)
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="contact_address"
                                                      name="contact_address" rows="3">{{ old('contact_address', $footerWidget->data['address'] ?? '') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="contact_phone"
                                                   name="contact_phone" value="{{ old('contact_phone', $footerWidget->data['phone'] ?? '') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="contact_email" class="form-label">Email</label>
                                            <input type="email" class="form-control" id="contact_email"
                                                   name="contact_email" value="{{ old('contact_email', $footerWidget->data['email'] ?? '') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="contact_whatsapp" class="form-label">WhatsApp</label>
                                            <input type="text" class="form-control" id="contact_whatsapp"
                                                   name="contact_whatsapp" value="{{ old('contact_whatsapp', $footerWidget->data['whatsapp'] ?? '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="social-content" class="content-section" style="display: none;">
                                ...
                                <div id="social-container">
                                    @php
                                        $socials = old('social', $footerWidget->data['social'] ?? []);
                                    @endphp
                                    @if($socials)
                            ...
                            <div id="custom-content" class="content-section" style="display: none;">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror"
                                              id="custom_content" name="content" rows="8">{{ old('content', $footerWidget->content) }}</textarea>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-1"></i> Update Widget
                            </button>
                        </div>
                    </form>
                </div>
...
$(document).ready(function() {
    let linkIndex = {{ count($footerWidget->data['links'] ?? []) ?: 1 }};
    let socialIndex = {{ count($footerWidget->data['social'] ?? []) ?: 1 }};
